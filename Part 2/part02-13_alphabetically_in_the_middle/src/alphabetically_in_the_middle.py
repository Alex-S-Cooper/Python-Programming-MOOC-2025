...
if (letter2 > letter1 and letter2 < letter3) or (letter2 > letter3 and letter2 < letter1):
    middle_letter = letter2

if (letter3 > letter1 and letter3 < letter2) or (letter3 > letter2 and letter3 < letter1):
